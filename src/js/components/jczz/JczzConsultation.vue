<template>
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <div class="base-appoint">
                ...
                <div class="base-con">
                    ...
                    <el-select v-model="value5" filterable placeholder="请选择" style="height:24px;margin-left:5px;">
                        <el-option
                                v-for="item in options"
                                placeholder="上午"
                                :key="item.value"
                ...
                <div class="base-con">
                    <el-form-item label="是否接受调剂:" prop="sex">
  ...
  background-color: #00b2b1;" @click="goBack">返回</el-button>
                    <el-button class="btn success1" type="text" style="padding:5px 20px" @click="open">确认预约</el-button>
                </div>
            </div>
        </el-form>
    </div>
...
<script>
    import Vue  from  "vue";
    import { Button, Radio, RadioGroup, Select, Option, DatePicker, Input, Message, Loading, Popover, MessageBox,Upload } from "element-ui";
    ...
    export default{
        ...
        methods: {
            ...
            goBack(){
                let _this=this;
                _this.$router.push("/main/videoConsultation");
            }
        }
    }
</script>