                    ...
                    <div class="base-docs" style="margin-top:10px;">
                        <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                            <div class="base-con">
                                ...
                                <el-select v-model="ruleForm.klx" readonly="true" style="width:150px;" placeholder="请选择卡号">
                            ...
                            <div class="base-con">
                                ...
                                <el-radio class="radio" disabled v-model="ruleForm.xb" label="男">男</el-radio>
                                <el-radio class="radio" disabled v-model="ruleForm.xb" label="女">女</el-radio>
                                ...
                                <el-input readonly="true"
                                    ...
                                    size="small"
                                ></el-input>
                                <label style="margin-left:40px;">其他联系方式:</label>
                                <el-input readonly="true"
                            ...
                            <div class="base-con">
                                ...
                                <el-select v-model="ruleForm.provinceId" readonly="true" placeholder="请选择" @change="getProvincess"
                                           style="width: 114px">
                                    <el-option
                                ...
                                <el-select v-model="ruleForm.cityId" readonly="true" placeholder="请选择" @change="getEaras"
                                           style="width: 114px">
                                    <el-option
                                        v-for="item in citys"
                                        :key="item.id"
                                ...
                                <el-select v-model="ruleForm.regionId" readonly="true" placeholder="请选择" style="width: 114px">
                                    <el-option
                                        v-for="item in earas"
                                        :key="item.id"
                                        :label="item.name"
                    ...
                    <el-form :model="ruleForm" ref="ruleForm"  label-width="100px" class="demo-ruleForm"
                        ...
                        <div class="base-con" style="margin-top:10px;float: left;width: 40%">
                            ...
                            <el-input readonly="true"
                                ...
                                size="small"
                            ></el-input>
                            <el-button class="btn" v-show="false" type="primary"
                                       style="margin-left:20px;padding:5px 10px;">常用诊断
                            </el-button>
                        </div>
                        ...
                        <div style="margin-top:10px;position:relative;">
                            ...
                            <div class="ghost-btn-wrap">
                                ...
                                <!--{{item.name}}-->
                                <!--</span>-->
                                <a :href="item.wjdz" v-show="oldNameList" class="showText"
                                   v-for="(item,index) of oldNameList">
                                    {{item.name}}
                                </a>
                            </div>
                        </div>
...
border-right:1px solid #E3E1E2;border-bottom:1px solid #E3E1E2;">
                ...
                <div v-show="!this.ruleForm.ywlx=='0'&&shzt=='1'" style="margin-top: 10px">
                    <div class="base-appoint" style="padding: 0">
                        ...
                        <div class="base-con" style="box-sizing: border-box;padding:10px 20px;">
                            ...
                            <span v-show="!(ruleForm.jcmc||ruleForm.ssmc)"
                                  style="font-size: 14px;color: #48576a;margin-right: 50px"> 病情等级 :
                   ...
                   <span v-show="ruleForm.jcmc" class="demonstration" style="color:#48576A;margin-right: 50px">期望检查日期 : {{this.ruleForm.sqyyrq}}
                    &nbsp;&nbsp;&nbsp;{{this.ruleForm.sqyylx == '0' ? '上午' : '下午'}}</span>
                            <span v-show="!(ruleForm.jcmc||ruleForm.ssmc)" class="demonstration"
                                  style="color:#48576A;margin-right: 50px">期望住院时间 : {{this.ruleForm.sqyyrq}}
                       &nbsp;&nbsp;&nbsp;{{this.ruleForm.sqyylx == '0' ? '上午' : '下午'}}</span>
                       ...
                       &nbsp;&nbsp;&nbsp;{{this.ruleForm.sqyylx == '0' ? '上午' : '下午'}}</span>
                        ...
                        <div class="base-con" style="box-sizing: border-box;padding:10px 20px;">
                            <span
                                style="margin-right: 50px;font-size: 14px;color: #48576a;">是否接受调剂 : {{this.ruleForm.djzt == '1' ? '是' : '否'}}</span>
                            <span v-show="this.ruleForm.djzt=='1'" class="demonstration"
                                  style="margin-right: 50px;margin-top:5px;margin-left:10px;">接受最晚时间:{{this.ruleForm.djrq}}</span>
                        </div>
                    </div>
                </div>
                <div v-show="!this.ruleForm.ywlx=='0'&&shzt=='1'&&this.type!='1'"
                    ...
                    <div class="base-appoint" style="padding: 0">
                        ...
                        <div v-show="radio=='2'">
                            <div style="overflow: hidden;padding:10px">
                                <el-form label-width="111px">
                                    <el-form-item label="驳回理由:" style="width: 80%">
                                        <!--<el-input v-model="desc" placeholder="可不填"></el-input>-->
                                        <el-input placeholder="最多输入200个字（选填）"
                                                  type="textarea"
                        ...
                        <div v-show="this.radio=='1'"
                             style="box-sizing:border-box;padding:0px 20px;margin-bottom: 20px;margin-top: 20px;margin-lfet:20px;">
                            ...
                            <span
                                style="margin-right: 20px;font-size: 14px;color: #48576a;margin-left: 20px">检查大类</span>
                            ...
                            <span
                                style="margin-right: 20px;font-size: 14px;color: #48576a;margin-left: 20px">检查项目</span>
                ...
                <div v-show="this.projectId&&this.radio=='1'">
                    <el-button :disabled="disabled" @click="lastDate" type="primary" style="padding:5px 20px;">上周
                    </el-button>
                    <el-button :disabled="!disabled" type="primary" @click="nextDate" style="padding:5px 20px;">下周
                    </el-button>
                </div>
                    ...
                    <div style="background: white">
                        ...
                        <div>
                            <el-table
                                ...
                                <el-table-column
                                    type="selection" show-overflow-tooltip="true"
                                >
                                </el-table-column>
                                <el-table-column
                                    prop="nUMNO"
  ...
  background-color: #00b2b1;" @click="goback">返回
            </el-button>
        </div>
    </div>
</template>
...
//                date = this.addDate(date,week*-1);
            ...
            async getData(id) {
                let ret = await axiosUtil('smarthos.sxzz.province.list', {});
                ret.succ && (this.provinces = ret.list);
                if (this.ruleForm.provinceId && this.ruleForm.cityId) {
                    this.getCity(this.ruleForm.provinceId);
                }
                if (this.ruleForm.regionId && this.ruleForm.cityId) {
                    this.earasList(this.ruleForm.cityId);
                }
            },
            getProvincess(value) {
                this.getCity(value)
